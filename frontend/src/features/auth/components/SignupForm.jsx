...
const SignupForm = () => {
  ...
  const validateStep = () => {
    ...
    if (step === 1) {
      ...
      if (!formData.churchId) newErrors.churchId = "Required";
  ...
  return (
    <div className="w-full max-w-lg">
      ...
      <form onSubmit={(e) => e.preventDefault()} className="mt-8">
        <div className="min-h-[380px] mb-10">{renderStep()}</div>
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className={`flex-[2] px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-bold shadow-xl shadow-blue-200/50 hover:shadow-2xl hover:shadow-blue-300/60 transform hover:-translate-y-0.5 transition-all active:scale-[0.98] ${
