    ...
    return (
        ...
        >
            <div className="w-full max-w-lg text-center md:text-left">
                <div className="mb-10">
                    <h2 className="text-4xl font-extrabold text-slate-900 mb-2 italic">Door's Open</h2>
                    <p className="text-slate-500 italic">Verification successful! Your journey with Lifeline starts now. Go find your better half.</p>
                </div>
