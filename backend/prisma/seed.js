...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var passwordHash, churches, counselors, churchId, sampleUsers, _i, sampleUsers_1, user, assignedCounselorId, account;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4:
                    if (!(_i < sampleUsers_1.length)) return [3 /*break*/, 8];
                    user = sampleUsers_1[_i];
                    assignedCounselorId = counselors[Math.floor(Math.random() * counselors.length)].id;
                    return [4 /*yield*/, db_1.prisma.account.upsert({
