...
var uploadProfileImageToCloudinary = function (fileBuffer) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, new Promise(function (resolve, reject) {
                        var stream = cloudinary_1.cloudinary.uploader.upload_stream({
                            folder: env_1.default.cloudinary.uploadFolder,
                            resource_type: "image",
